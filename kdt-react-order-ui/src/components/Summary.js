        ...
        <>
            ...
            <form>
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control mb-1" value={order.email} id="email" onChange={handleEmailInputChange}/>
                </div>
                <div className="mb-3">
                    <label htmlFor="address" className="form-label">주소</label>
                    <input type="text" className="form-control mb-1" value={order.address} id="address" onChange={handleAddressInputChange}/>
                </div>
                <div className="mb-3">
                    <label htmlFor="postcode" className="form-label">우편번호</label>
                    <input type="text" className="form-control" value={order.postcode} id="postcode" onChange={handlePostcodeInputChange}/>
                </div>
