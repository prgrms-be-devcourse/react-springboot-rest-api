...
public class OrderJdbcRepository implements OrderRepository {
    ...
    private Map<String, Object> toOrderItemParamMap(UUID orderId, LocalDateTime cratedAt, LocalDateTime updatedAt, OrderItem orderItem) {
        var paramMap = new HashMap<String, Object>();
        ...
        paramMap.put("createdAt", cratedAt);
