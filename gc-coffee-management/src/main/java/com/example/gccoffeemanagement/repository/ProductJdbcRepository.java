...
import static com.example.gccoffeemanagement.repository.Utils.toLocalDateTime;
import static com.example.gccoffeemanagement.repository.Utils.toUUID;
...
public class ProductJdbcRepository implements ProductRepository {
    ...
    public Product insert(Product product) {
        int insert = jdbcTemplate.update("INSERT INTO products(product_id, product_name, category, price, description, created_at, updated_at)" +
    ...
    private static final RowMapper<Product> productRowMapper = (resultSet, i) -> {
        ...
        Integer price = Integer.valueOf(resultSet.getString("price"));
